    ...
    export default {
        ...
        methods: {
            ...
            changeStore(event) {
                ...
                this.selectList.wareHouse = baseUtil.getMetadataWareHouseByStoreId(this.storeId) || [];
                this.search();
            },
            search(page) {
                let params = {...this.form, limit: 10, start: 0, query: this.query, storeId: this.storeId}
                if (page) {
