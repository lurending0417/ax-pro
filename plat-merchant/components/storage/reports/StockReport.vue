    ...
    <div>
        ...
        <table class="table table-bordered">
            ...
            <tr v-for="(item, index) in tableView">
                ...
                <td>{{item.startRegularPrice }}</td>
                <td>{{item.startProcessingCharges}}</td>
                ...
                <td class="bgColorIN"
                    @click="clickTd(item, index, 'in')">{{item.inRegularPrice }}
                </td>
                <td class="bgColorIN"
                    @click="clickTd(item, index, 'in')">{{item.inProcessingCharges}}
                </td>
                <td class="bgColorIN"
                    @click="clickTd(item, index, 'in')">{{item.inWeight }}
                </td>

                <td class="bgColorOUT" @click="clickTd(item, index, 'out')">{{item.outAmount}}</td>
                <td class="bgColorOUT" @click="clickTd(item, index, 'out')">{{item.outRegularPrice }}</td>
                <td class="bgColorOUT" @click="clickTd(item, index, 'out')">{{item.outProcessingCharges }}</td>
                <td class="bgColorOUT" @click="clickTd(item, index, 'out')">{{item.outWeight}}</td>

                <td class="bgColorEDIT" @click="clickTd(item, index, 'modify')">{{item.editRegularPrice }}</td>
                <td class="bgColorEDIT" @click="clickTd(item, index, 'modify')">{{item.editProcessingCharges }}</td>
                <td class="bgColorEDIT" @click="clickTd(item, index, 'modify')">{{item.editWeight}}</td>

                <td>{{item.endAmount }}</td>
                <td>{{item.endRegularPrice }}</td>
                <td>{{item.endProcessingCharges }}</td>
