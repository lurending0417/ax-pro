<template>
    <div>
        ...
        <TableCpn :heads="[
                    ...
                    {propName: 'totalRetailPrice', name: '金额', unit: '元'},
    ...
    export default {
        ...
        methods: {
            ...
            changeStoreId(params) {
                let staffs = baseUtil.getStaffsInDesignStoreByStoreId(params.storeId)
                let warehouses = baseUtil.getWareHouseInDesignStoreByStoreId(params.storeId)
