...
<script>
    ...
    import ResourceManageAdd from '~/components/auth/actionPageTplManage/ResourceManageAdd'
    import ResourceManageModify from '~/components/auth/actionPageTplManage/ResourceManageModify'
