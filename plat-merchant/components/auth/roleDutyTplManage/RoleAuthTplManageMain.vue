...
<script>
    ...
    import RoleAuthTplManageAdd from '~/components/auth/roleDutyTplManage/RoleAuthTplManageAdd'
    import RoleAuthTplManageModify from '~/components/auth/roleDutyTplManage/RoleAuthTplManageModify'
    ...
    export default {
        ...
        computed: {
            ...mapGetters('authTpl/roleAuthTplManageAdd', {
                getRoleAuthTpls: 'getRoleAuthTpls'
            })
        },
        methods: {
            ...mapActions('authTpl/roleAuthTplManageAdd', {
