        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-lg-3 left-config">
                    ...
                    <div style="line-height: 34px">金属</div>
                    <div style="line-height: 34px">宝石</div>
                    <div style="line-height: 34px">品类</div>
                </div>
                <div class="col-lg-9 right-config">
                    ...
                    <div>
                        <label class="checkbox-inline">
                            <input type="checkbox" name="metal" v-model="category.isCheckAll">全选</label>
                        <label class="checkbox-inline" v-for="item in category.categoryArr">
                            <input type="checkbox" name="metal" :value="item.id" v-model="category.checkedArr">{{item.name}}</label>
                    </div>
                </div>
            </div>
        </div>
