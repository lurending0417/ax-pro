...
<script>
    ...
    import DutyAuthTplManageAdd from '~/components/merchant/DutyAuthTplManageAdd'
    import DutyAuthTplManageModify from '~/components/merchant/DutyAuthTplManageModify'
    ...
    export default {
        ...
        computed: {
            ...mapGetters('merchant/dutyAuthTplManageAdd', {
                getDutyAuthTpls: 'getDutyAuthTpls'
            })
        },
        methods: {
            ...mapActions('merchant/dutyAuthTplManageAdd', {
