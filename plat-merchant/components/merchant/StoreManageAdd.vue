...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            clickAsure() {
                let vm = this;
                // if (!this.baseInfo.districtCode) {
                //     this.baseInfo.districtCode = '110101'
                // }
                let sendParams = this.baseInfo;
                sendParams.districtName = regionUtil.getDetailAddress(this.baseInfo.districtCode, this.reginData);
                this.sendInfo.districtName = regionUtil.getDetailAddress(this.sendInfo.districtCode, this.reginData);
                this.receiveInfo.districtName = regionUtil.getDetailAddress(this.receiveInfo.districtCode, this.reginData);
                ...
                this.addStoreToMerchant({
                    ...
                    falseCallBack: (msg) => {
                        this.plainAlertBoxParams.isShowPlainAlertBox = true;
                        this.plainAlertBoxParams.msg = msg;
                    },
                    sendParams
                });
            },
