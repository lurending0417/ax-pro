            ...
            <form class="form-horizontal" style="margin-top: 16px">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" v-model="baseInfo.name" disabled>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control"  maxlength="100" v-model="baseInfo.intro" disabled></textarea>
                        </div>
                    </div>
                    <RegionSelect :params="{
                            data: reginData,
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" disabled v-model="baseInfo.address">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">联系人</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" disabled v-model="baseInfo.managerName">
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" disabled v-model="baseInfo.managerPhone">
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" disabled v-model="baseInfo.servicePhone">
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    <div class="form-group" style="text-align: left">
                        ...
                        <div class="radio col-sm-4">
                            <label>
                                <input type="radio" value="false" disabled name="status" v-model="baseInfo.enabled">禁用
                            </label><br/>
                            <label style="margin-top: 6px">
                                <input type="radio" value="true" disabled name="status" v-model="baseInfo.enabled">启用
                            </label>
                        </div>
                    </div>
                    <div class="form-group" style="text-align: left">
                        ...
                        <div class="radio col-sm-4">
                            <label>
                                <input type="radio" name="type" disabled value="MANAGE" v-model="baseInfo.type">管理门店
                            </label><br/>
                            <label style="margin-top: 6px">
                                <input type="radio" name="type" disabled value="NORMAL" v-model="baseInfo.type">普通门店
                            </label>
                        </div>
                    </div>
                </fieldset>
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">详细地址</label>
                        <div class="col-sm-6">
                            <input type="text" disabled class="form-control" v-model="sendInfo.street">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">联系人</label>
                        <div class="col-sm-4">
                            <input type="text" disabled class="form-control" v-model="sendInfo.name">
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">联系电话</label>
                        <div class="col-sm-4">
                            <input type="text" disabled class="form-control" v-model="sendInfo.telephone">
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                </fieldset>
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">详细地址</label>
                        <div class="col-sm-6">
                            <input type="text" disabled class="form-control" v-model="receiveInfo.street">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">联系人</label>
                        <div class="col-sm-4">
                            <input type="text" disabled class="form-control" v-model="receiveInfo.name">
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">联系电话</label>
                        <div class="col-sm-4">
                            <input type="text" disabled class="form-control" v-model="receiveInfo.telephone">
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                </fieldset>
