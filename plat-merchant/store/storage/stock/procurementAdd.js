...
export default {
    ...
    getters: {
        preStockView (state) {
            ...
            view.wareHouseName = baseUtil.getMetadataWareHouseById(view.wareHouseId).name
            view.vendorName = baseUtil.getMetadataVendorById(view.vendorId).name
            view.staffName = baseUtil.getMetadataStaffById(view.creatorId).name
