...
export default {
    ...
    getters: {
        ...
        getMetals: () => {
            return baseUtil.getMetadataMetal()
        },
        ...
        getRejectWareHouse: () => {
            return baseUtil.getMetadataRejectWareHouse()
        },
        getUserInfo: state => {
        ...
        getExchangeBillDetail: state => {
            state.exchangeBillDetail.wareHouseId = baseUtil.getMetadataWareHouseById(state.exchangeBillDetail.wareHouseId).name
