<template>
    <div>
        ...
        <el-row type="flex" justify="space-between" class="m-t">
            <el-col :span="12">
                <el-card class="box-card">
                    <div slot="header">
                        <span><span class="text-danger text-bold">商户</span>页面树</span>
                    </div>
                    <el-tree
                        :data="treeNodes"
                        highlight-current
            ...
            <el-col :span="12">
                <el-card class="box-card m-l">
                    <div slot="header">
                        <span><span class="text-danger text-bold">商户</span>功能树</span>
                    </div>
                    <el-tree
        ...
        <PageGroupEditor :options="groupModal" @close="closePageGroupEditor"></PageGroupEditor>

        <PageEditor :options="pageModal" @close="closePageEditor"></PageEditor>

        <TabEditor :options="tabModal" @close="closeTabEditor"></TabEditor>
        ...
        methods: {
            ...
            deletePageGroup() {
                this.$confirm('您确定要删除选中的页面分组吗？', '提示', {
                    ...
                    api.request({
                        url: api.url.auth.page.group.del,
                        params: {
            ...
            actionTree(pageId) {
                ...
                api.request({
                    url: api.url.auth.page.action.tree,
                    params: {
                        pageId: pageId
                    },
                    success: (json) => {
            ...
            setAction: lodash.debounce(function () {
                ...
                api.request({
                    url: api.url.auth.page.action.add,
                    params: {
                        pageId: this.currentNode.id,
                        actionIds: actionIds
                    },
