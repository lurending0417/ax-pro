    ...
    <div>
        <el-row type="flex" justify="space-between">
            ...
            <el-col :span="8" class="text-right">
                <el-button type="success" icon="el-icon-circle-plus" @click="addCategory">&nbsp;添加品类</el-button>
            </el-col>
        </el-row>
            ...
            <el-table-column label="操作" width="280" align="center">
                <template slot-scope="scope">
                    <div class="nowrap">
                        ...
                        <el-button size="mini" type="primary" @click="editCategory(scope.row)">修改</el-button>
        ...
        <CategoryEditor :options="editorModal" @close="closeEditor"></CategoryEditor>
...
<script>
    ...
    export default {
        ...
        methods: {
            list() {
                api.request({
                    url: api.url.goods.category.list,
                    params: this.params,
                    success: (json) => {
                        this.rows = json.rows;
            ...
            deleteCategory(row) {
                this.$confirm('您确定要删除选中的品类吗？', '提示', {
                    type: 'warning'
                }).then(() => {
                    api.request({
                        url: api.url.goods.category.del,
                        params: {
                            categoryId: row.id
                        },
                        success: () => {
