    ...
    <div>
        <el-row type="flex" justify="space-between">
            ...
            <el-col :span="8" class="text-right">
                <el-button type="success" icon="el-icon-circle-plus" @click="addMetal">&nbsp;添加材质</el-button>
            </el-col>
        </el-row>
            ...
            <el-table-column label="操作" width="280" align="center">
                <template slot-scope="scope">
                    <div class="nowrap">
                        ...
                        <el-button size="mini" type="primary" @click="editMetal(scope.row)">修改</el-button>
                        <el-button size="mini" type="danger" @click="deleteMetal(scope.row)">删除</el-button>
        ...
        <MetalEditor :options="editorModal" @close="closeEditor"></MetalEditor>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteMetal(row) {
                this.$confirm('您确定要删除选中的材质吗？', '提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning'
                }).then(() => {
                    api.request({
                        url: api.url.goods.metal.del,
                        params: {
                            metalId: row.id
                        },
                        success: () => {
