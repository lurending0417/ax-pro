    ...
    <div>
        <el-row type="flex" justify="space-between">
            ...
            <el-col :span="8" class="text-right">
                <el-button type="success" icon="el-icon-circle-plus" @click="addAccount">&nbsp;添加账户</el-button>
            </el-col>
        </el-row>
        <el-table
            :data="rows"
            ...
            border
            style="width:100%">
            <el-table-column prop="gatewayClassName" label="网关类名" width="250" :formatter="renderGateway"></el-table-column>
            <el-table-column prop="appId" label="appId"></el-table-column>
            <el-table-column prop="appSecret" label="appSecret"></el-table-column>
            <el-table-column prop="voice" label="语音接口" :formatter="renderVoice"></el-table-column>
            ...
            <el-table-column label="操作" width="220" align="center">
                <template slot-scope="scope">
                    <div class="nowrap">
                        <el-button size="mini" type="primary" @click="editAccount(scope.row)">修改</el-button>
        ...
        <SmsGatewayAccountEditor :options="editorModal" @close="closeEditor"></SmsGatewayAccountEditor>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteAccount(row) {
                this.$confirm('您确定要删除选中的网关账户吗？', '提示', {
                    type: 'warning'
                }).then(() => {
                    api.request({
                        url: api.url.sms.gateway.account.del,
                        params: {
                            accountId: row.id
                        },
                        success: () => {
