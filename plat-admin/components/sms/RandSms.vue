<template>
    <div>
        ...
        <el-table :data="rows" stripe border highlight-current-row header-cell-class-name="text-center">
            ...
            <el-table-column align="center" prop="rand" label="验证码"></el-table-column>
            <el-table-column align="center" prop="voice" label="语音" :formatter="renderVoice"></el-table-column>
            ...
            <el-table-column align="center" width="180" prop="verifyTime" label="验证通过时间" :formatter="renderTime"></el-table-column>
