import api from '~/api'
import {dateUtil, baseUtil, calculateUtil, componentUtil} from '~/util'
    ...
    getters: {
        ...
        getInventoryBillsView: state => {
            ...
            temp = state.inventoryBills.map(bill => {
                ...
                if (componentUtil.getInventoryBillStatus(bill.status)) {
                    bill.status = componentUtil.getInventoryBillStatus(bill.status)
                }
