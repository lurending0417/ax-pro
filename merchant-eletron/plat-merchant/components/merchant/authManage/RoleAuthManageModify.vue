...
<script>
    ...
    export default {
        ...
        computed: {
            labels() {
                let labelObj = {}
                if (this.currentClickItem.type === 'role') {
                    labelObj = {
                        num: '角色编号',
                        name: '角色名称'
                    }
                } else if (this.currentClickItem.type === 'roleGroup') {
                    labelObj = {
                        num: '角色分组编号',
                        name: '角色分组名称'
                    }
        ...
        methods: {
            ...mapActions('merchant/roleAuthManageModify', {
                apiGetOneRoleGroupAuth: 'apiGetOneRoleGroupAuth',
                apiGetOneRoleAuth: 'apiGetOneRoleAuth',
                apiModifyRoleGroupAuth: 'apiModifyRoleGroupAuth',
                apiModifyRoleAuth: 'apiModifyRoleAuth'
            }),
            closeModal(name) {
