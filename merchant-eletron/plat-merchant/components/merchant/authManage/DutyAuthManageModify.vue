...
<script>
    ...
    export default {
        ...
        computed: {},
        methods: {
            ...mapActions('merchant/dutyAuthManageModify', {
                apiGetOneDutyAuth: 'apiGetOneDutyAuth',
                apiModifyDutyAuth: 'apiModifyDutyAuth'
            }),
            closeModal (name) {
