    ...
    <div>
        ...
        <TableCpn
            :heads="[
                ...
                {propName:'totalCost',name:'应收金额', unit: '元'},
                {propName:'paymentOfCash',name:'现金',mergeName:'支付方式', unit: '元'},
                {propName:'paymentOfPos',name:'POS',mergeName:'支付方式', unit: '元'},
                {propName:'paymentOfWeixin',name:'微信',mergeName:'支付方式', unit: '元'},
                {propName:'paymentOfAlipay',name:'支付宝',mergeName:'支付方式', unit: '元'},
                {propName:'paymentOfGold',name:'易戴易美黄金',mergeName:'支付方式', unit: '元'},
                {propName:'paymentOfWallet',name:'易戴易美资金',mergeName:'支付方式', unit: '元'},
                {propName:'cashOddChange',name:'现金找零',mergeName:'支付方式', unit: '元'},
                {propName:'realPrice',name:'实付汇总', unit: '元'},
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            // this.wareHouse = baseUtil.getMetadataWareHouseByStoreId(); // 获取当前店铺的所有仓库
            this.$on('paymentBill', () => {
