<template>
    <div>
        <div class="form-inline">
            ...
            <div class="form-group form-group-margin">
                ...
                <select class="form-control" style="margin-left: 15px" ref="wareHouseId" v-model="form.wareHouseId"
                    ...
                    <option v-for="wareHouse in rejectWareHouses" :value="wareHouse.id">{{wareHouse.name}}</option>
                </select>
            </div>
        </div>
        <div class="row">
        ...
        <TableCpn :heads="[
                    ...
                    {propName: 'totalCost', name: '回收金额', unit: '元'},
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.rejectWareHouses = baseUtil.getMetadataRejectWareHouse()
