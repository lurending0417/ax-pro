    ...
    <div>
        ...
        <TableCpn
            :heads="[
                ...
                {propName:'netWeight',name:'来料净重', unit: 'g'},
                {propName:'roughWeight',name:'售货重量', unit: 'g'},
            ...
            <div v-for="(item,index) in getExchangeBills" :slot="'BUTTON'+index">
                ...
                <button class="btn btn-sm btn-danger" @click="clickDelete(item)">删除</button>
            </div>
        </TableCpn>
...
<script>
    ...
    export default {
        ...
        mounted () {
            ...
            this.staffs = baseUtil.getMetadataStaffByStoreId() // 获取当前店铺的所有员工
            this.$on('exchangeBill', () => {
                this.search({start: 0, limit: 20})
            });
        },
        beforeMount () {
