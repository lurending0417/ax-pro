<template>
    <div class="vue-datepicker" style="display: inline-block;" @mouseout="endChoice" @mouseover="startMouseOver">
        <input class="datepicker-form-control" type="text" autocomplete="off" disableautocomplete :name="field" :value="value"
               :placeholder="placeholder" @focus="startChoice" @keypress="startChoice" @blur="endChoice" ref="input"/>
        <div class="vue-datepicker-panels" v-show="dayPanelIsShow || monthPanelIsShow">
            ...
            <div class="vue-datepicker-panel" v-show="monthPanelIsShow">
                ...
                <table class="vue-datepicker-tb2">
                    ...
                    <thead>
                    <tr>
                        <th v-for="season in monthArr"></th>
                    </tr>
                    </thead>
                    <tbody>
