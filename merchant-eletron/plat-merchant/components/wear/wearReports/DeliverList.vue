<template>
    <div>
        <div class="form-inline">
            ...
            <SelectItem v-model="storeId" selectTitle="发货门店" :selectItems="stores"></SelectItem>
            <SelectItem v-model="form.wareHouseId" selectTitle="发货仓库" :selectItems="wareHouses"></SelectItem>
        ...
        <div class="row">
            <div class="col-md-3">
                <input type="text" class="form-control" v-model="query" @keyup.enter="search()" placeholder="条码" />
            </div>
            <div class="col-md-1">
        ...
        <TableCpn
            :heads="[
                { propName: 'createTime', name: '发货时间' },
                { propName: 'billNumber', name: '订单号' },
                { propName: 'billTime', name: '下单时间' },
                ...
                { propName: 'storeName', name: '发货门店' },
                { propName: 'wareHouseName', name: '发货仓库' },
                { propName: 'depositCost', name: '押金' ,unit: '元'},
                { propName: 'rentCost', name: '租金' ,unit: '元'},
    ...
    export default {
        ...
        methods: {
            ...
            searchDeliverReport(params) {
                api.request({
                    url: api.consts._LEASE_STORAGE_STAT_OUT,
                    params,
                    success: (data) => {
