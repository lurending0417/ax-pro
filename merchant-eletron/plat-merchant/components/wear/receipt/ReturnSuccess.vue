<template>
    <div>
        ...
        <TableCpn
            ...
            :items="getWearRecordDoneQcOk"
        >
            <div v-for="(item,index) in getWearRecordDoneQcOk" :slot="'BUTTON'+index">
                <ButtonWithModal
                    :btnProps="{
...
<script>
    ...
    import DeliverDetail from './ReturnSuccessModal/DeliverDetail';
    ...
    export default {
        ...
        computed: {
            ...mapGetters('wear/wearRecords', {
                getWearRecordDoneQcOk: 'getWearRecordDoneQcOk',
                total: 'getTotal'
            })
        },
        methods: {
