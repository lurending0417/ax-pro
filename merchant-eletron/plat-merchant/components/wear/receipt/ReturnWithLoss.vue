<template>
    <div>
        ...
        <TableCpn
            ...
            :items="getWearRecordDoneQcFail"
        >
            <div v-for="(item,index) in getWearRecordDoneQcFail" :slot="'BUTTON'+index">
                <ButtonWithModal
                    :btnProps="{
        ...
        <ModalItem
            ...
            <RejectInspection slot="main" :validateParams="validateParams"></RejectInspection>
        </ModalItem>
    </div>
</template>
...
<script>
    ...
    import DeliverDetail from './ReturnWithLoss/DeliverDetail';
    import RejectInspection from './ReturnWithLoss/RejectInspection';
    ...
    export default {
        ...
        data() {
            return {
                ...
                form: {
                    backStoreId: '',
                    outStoreId: '',
                    status: 'DONE_QC_FAIL,WAIT_QC_CONFIRM'
                },
                query: '',
                initStatus: true
            }
        ...
        computed: {
            ...mapGetters('wear/wearRecords', {
                getWearRecordDoneQcFail: 'getWearRecordDoneQcFail',
                total: 'getTotal'
            })
        },
        methods: {
