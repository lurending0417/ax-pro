<template>
    <div>
        ...
        <TableCpn
            ...
            :items="getWearRecordLeasing"
        >
            <div v-for="(item,index) in getWearRecordLeasing" :slot="'BUTTON'+index">
                <ButtonWithModal
                    :btnProps="{
...
<script>
    ...
    import DeliverDetail from './UserReceiveModal/DeliverDetail';
    ...
    export default {
        ...
        data() {
            return {
                ...
                form: {
                    outStoreId: '',
                    status: 'LEASING,BACK_SHIPPING_REQUESTED'
                },
                query: '',
                initStatus: true
            }
        ...
        computed: {
            ...mapGetters('wear/wearRecords', {
                getWearRecordLeasing: 'getWearRecordLeasing',
                total: 'getTotal'
            })
        },
        methods: {
