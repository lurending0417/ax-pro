<template>
    <div>
            ...
            <div class="statusWrap" v-if="deliverDetailItem.traces && deliverDetailItem.traces.length > 0">
                <div class="flex-cls">
                    ...
                    <div v-for="(item, index) in deliverDetailItem.traces" class="status-items-cls" v-if="index>0">
                        <div class="back-line-cls" :class="item.isEnd ? 'width-left': ''"></div>
                        <i class="fa fa-circle icon-cls" aria-hidden="true"></i>
        ...
        <fieldset>
            <legend>商品信息</legend>
            <div class="line-cls">
                <KeyValueCom :title="'门店：'" :value="deliverDetailItem.leaseRecord.storeName"></KeyValueCom>
                <KeyValueCom :title="'仓库：'" :value="deliverDetailItem.leaseRecord.wareHouseName"></KeyValueCom>
            </div>
            <div class="line-cls">
