<template>
    <table class="table table-bordered table-cls">
        ...
        <tr v-for="(item, index) in getPaymentBills">
            ...
            <td>{{handleItemUnit(item.paymentOfCash, '元')}}</td>
            <td>{{handleItemUnit(item.paymentOfPos, '元')}}</td>
            <td>{{handleItemUnit(item.paymentOfWeixin, '元')}}</td>
            <td>{{handleItemUnit(item.paymentOfAlipay, '元')}}</td>
            <td>{{handleItemUnit(item.paymentOfGold, '元')}}</td>
            <td>{{handleItemUnit(item.paymentOfWallet, '元')}}</td>
            <td>{{handleItemUnit(item.cashOddChange, '元')}}</td>
            <td>{{handleItemUnit(item.realPrice, '元')}}</td>
