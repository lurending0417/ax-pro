    ...
    <form class="form-horizontal" style="margin-top: 16px">
        ...
        <div class="form-group" style="text-align: left">
            ...
            <div class="radio col-sm-9">
                <label>
                    <input type="radio" name="radios" :value="false" @change="changeEnabled" :checked="!categoryEnable">
                    禁用
                </label><br/>
                <label style="margin-top: 6px">
                    <input type="radio" name="radios" :value="true" @change="changeEnabled" :checked="categoryEnable">
                    启用
                </label>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapMutations('storage/warebaseinfo/categoryItemModify', {
                resetInfo: 'resetInfo',
            ...
            ...mapActions('storage/warebaseinfo/categoryItemModify', {
                modifyCategotyItem: 'modifyCategotyItem'
            }),
            initResetInfo(obj) {
                this.resetInfo(obj)
            },
        ...
        mounted() {
            ...
            ButtonWithModalEvent.$on(this.CONST_CLICK_MODAL, () => {
                this.categoryEnable = this.params.enabled === '启用'
