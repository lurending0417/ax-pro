    ...
    export default {
        ...
        watch: {
            storeId: function (val) {
                ...
                if (val) {
                    this.selectList.wareHouse = baseUtil.getMetadataWareHouseByStoreId({storeId: val, enabled: true})
                    this.form.wareHouseId = this.selectList.wareHouse[0].id;
                } else {
                    this.selectList.wareHouse = baseUtil.getMetadataWareHouseByStoreId({enabled: true, storeId: baseUtil.getMetadataStore()[0].id})
                    this.form.wareHouseId = this.selectList.wareHouse[0].id;
                }
        ...
        methods: {
            ...
            search() {
                this.apiGetStockItem({...this.form, start: 0, limit: 20, query: this.query})
            },
