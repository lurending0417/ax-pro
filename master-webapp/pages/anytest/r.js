...
export default class Record extends React.PureComponent{
	render(){
		return <div>
			...
			<input onClick={this.stopRecording} type="button" value="停止" />
			<input onClick={this.playRecording} type="button" value="播放" />
			<input onClick="uploadAudio()" type="button" value="提交" />
			<input onClick={this.cancelAudio} type="button" value="取消" />
		</div>
	}
